...
<html lang="en">
  ...
  <head>
    ...
    <title>TRANSPORT REQUISITION FORM</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top" style="background-image: linear-gradient(pink,#2144);">
      ...
      <a class="navbar-brand mr-1" href="index.php">TRANSPORT REQUISITION FORM</a>
       ...
       <!-- <li class="nav-item dropdown">
        ...
        <li class="nav-item">
          <a class="nav-link" href="userbus.php">
            ...
            <span>TRANSPORT REQUEST FORM</span></a>
        </li>
      </ul>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb"
            <li class="breadcrumb-item" style="background-image: linear-gradient();">
              <a href="index."> <h2> TRANSPORT REQUISITION FORM </h2> </a>
            </li>
